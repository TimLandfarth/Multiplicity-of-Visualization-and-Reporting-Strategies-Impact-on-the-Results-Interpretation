...
fig_2 <- function(datset1, datset2, datset3, label, label.x){
  ...
  p1 <- ggplot(datset1, aes(x = task.id, y = forcats::fct_rev(approach), fill = cv_mean_cindex))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = "Dataset", fill = "Cindex")+
    theme(legend.position = "right",
  ...
  p2 <- ggplot(datset2, aes(x = task.id, y = forcats::fct_rev(approach), fill = cv_mean_ibrier))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
  ...
  p3 <- ggplot(datset3, aes(x = task.id, y = forcats::fct_rev(approach), fill = cv_mean_spars))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = label.x, fill = "No. of\nfeatures")+
    theme(legend.position = "right",
...
# 3. x: Dat, y: Learner----
#pdf(file = "dataset_learner.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "dataset_approach_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "learner_dataset.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
#pdf(file = "approach_dataset_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_allmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_allmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_allmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
#pdf(file = "approach_dataset_allmean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
