...
#pdf(file = "dataset_approach_cmin.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_cmax.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_cmed.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imin.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imax.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_imed.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smin.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smax.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_smed.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemin.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemax.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemed.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "dataset_approach_allemean.pdf", width = pdf_w_h[1]*1.25, height = pdf_w_h[2] * 1.25)
...
#pdf(file = "learner_dataset.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2)
...
#pdf(file = "approach_dataset_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_allmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_allmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_allmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
#pdf(file = "approach_dataset_allmean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
