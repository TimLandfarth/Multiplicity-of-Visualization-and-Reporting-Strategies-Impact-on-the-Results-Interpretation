...
# 3. x: dataset, y: Performance, color: Approach, Ref: ...----
## 3.1 Cindex----
### 3.1.1 Minimum----
...
#pdf(file = "cmean_imean.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
# 4. x: dataset, y: Performance, color: Approach, Ref: Kaplan Meier----
## 4.1 Cindex----
### 4.1.1 Minimum----
...
#pdf(file = "km_cmean_imean.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
# 4. x: dataset, y: Performance, color: Approach, Ref: Cox proportional hazard----
## 4.1 Cindex----
### 4.1.1 Minimum----
df_cmin <- df %>% filter(learner.id != "Kaplan\nMeier") %>% group_by(approach, task.id) %>% filter(cv_mean_cindex == min(cv_mean_cindex)) %>% ungroup()

#pdf(file = "ph_cmin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmin_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmed_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmax_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
#pdf(file = "ph_cmean_imean.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
