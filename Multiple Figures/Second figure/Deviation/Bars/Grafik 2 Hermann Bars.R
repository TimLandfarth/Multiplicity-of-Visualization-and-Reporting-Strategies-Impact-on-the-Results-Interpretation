...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_dmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_dmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
fig1(df_cmed, df_imed, "Performance measure\nfor the mean cindex and mean ibrier", Ref = "Kaplan\nMeier", label.x = "Learner")
dev.off()

rm(df_cmean, df_imean)

# 4. x: Learner, y: Mase, Ref: Cox PH----
## 4.1 Dataset----
### 4.1.1 Minimum----
df_dmin <- df[df$n == min(df$n),]

pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_dmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_dmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_dmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/learner_ph_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
fig1(df_cmean, df_imean, "Performance measure\nfor the mean cindex and mean ibrier", Ref = "Cox\nproportional\nhazard", label.x = "Learner")
dev.off()

rm(df_cmean, df_imean)

# 5. x: Approach, y: Mase, Ref: Reference
## 5.1 x:dataset, y:mase----
### 5.1.1 Minimum----
#### 5.1.1.1 Cindex----
##### 5.1.1.1.1 Minimum----
df_dmincmin <- df %>% filter(task.id == "LAML") %>% group_by(approach) %>% filter(cv_mean_cindex == min(cv_mean_cindex)) %>% ungroup()

pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmin_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmax_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_dmed_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_cmin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_cmax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_cmed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_imin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_imax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_imed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_allemin.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_allemax.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_allemed.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Deviation/Bars/approach_allemean.pdf", width = pdf_w_h[1]*1.5, height = pdf_w_h[2] * 1.5)
