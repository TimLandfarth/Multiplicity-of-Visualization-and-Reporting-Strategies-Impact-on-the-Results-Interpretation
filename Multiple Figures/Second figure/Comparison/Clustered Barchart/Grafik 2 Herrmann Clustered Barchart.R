...
# 3. x: learner, y = mase, color = dataset----
## 3.1 Cindex----
### 3.1.1 Minimum----
df_cmin <- df %>%
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_allmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_allmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_allmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/learner_dataset_allmean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
# 4. x: approach, y = mase, color = dataset----
## 4.1 Cindex----
### 4.1.1 Minimum----
df_cmin <- df %>%
  filter(task.id %in% c("LAML", "KIRC", "BRCA")) %>% 
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_allemin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_allemax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_allemed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/approach_dataset_allemean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
# 5. x: Dataset, y = mase, color = approach----
## 5.1 Cindex----
### 5.1.1 Minimum----
df_cmin <- df %>%
  group_by(task.id, approach) %>% filter(cv_mean_cindex == min(cv_mean_cindex)) %>% filter(1:n() == 1)

pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_allemin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_allemax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_allemed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Clustered Barchart/dataset_approach_allemean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
