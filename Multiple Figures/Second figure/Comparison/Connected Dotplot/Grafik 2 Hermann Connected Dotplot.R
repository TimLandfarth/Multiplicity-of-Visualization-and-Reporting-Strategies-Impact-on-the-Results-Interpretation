...
# 3. x = learner, y = Mase, erster/zweiter Dot: min/max Dataset----
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/learner.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
plot_grid(ggdraw() + 
...
# 4. x = Approach, y = Mase, erster/zweiter Dot: min/max Dataset----
## 4.1 cindex----
### 4.1.1 Minimum----
df_cmin <- df %>% filter(task.id %in% c("LAML", "BRCA")) %>% group_by(approach, task.id) %>% filter(cv_mean_cindex == min(cv_mean_cindex))

pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_allemin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_allemax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_allemed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Connected Dotplot/approach_allemean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
