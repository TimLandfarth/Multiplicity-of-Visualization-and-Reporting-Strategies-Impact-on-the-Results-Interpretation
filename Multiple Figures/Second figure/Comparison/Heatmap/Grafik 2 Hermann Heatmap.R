...
p1 <- ggplot(datset1, aes(x = task.id, y = learner.id, fill = cv_mean_cindex))+
  geom_raster()+
  ...
  scale_fill_gradient(limits = c(0,1), low = "#C8E7FF", high = col_h[2])+
  facet_grid(approach~., space="free_y", scales="free_y", switch="y")

p2 <- ggplot(datset2, aes(x = task.id, y = learner.id, fill = cv_mean_ibrier))+
  geom_raster()+
  theme_tufte(base_family = "sans")+
  ...
  theme(legend.position = "right",
        ...
        axis.text.x = element_blank(),
        axis.title.x = element_blank())+
  scale_fill_gradient(low = "#C8E7FF", high = col_h[2], limits = c(0,1))+
  facet_grid(approach~., space="free_y", scales="free_y", switch="y")

p3 <- ggplot(datset3, aes(x = task.id, y = learner.id, fill = cv_mean_spars))+
  geom_raster()+
  theme_tufte(base_family = "sans")+
  ...
  theme(legend.position = "right",
        axis.ticks = element_blank(),
        strip.placement = "outside")+
  scale_fill_gradient(low = "#C8E7FF", high = col_h[2])+
  facet_grid(approach~., space="free_y", scales="free_y", switch="y")
...
fig_2 <- function(datset1, datset2, datset3, label, label.x){
  ...
  p1 <- ggplot(datset1, aes(x = task.id, y = approach, fill = cv_mean_cindex))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = "Dataset", fill = "Cindex")+
    theme(legend.position = "right",
  ...
  p2 <- ggplot(datset2, aes(x = task.id, y = approach, fill = cv_mean_ibrier))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
  ...
  p3 <- ggplot(datset3, aes(x = task.id, y = approach, fill = cv_mean_spars))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = label.x, fill = "No. of\nfeatures")+
    theme(legend.position = "right",
...
fig_3 <- function(datset1, datset2, datset3, label, label.x){
  ...
  p1 <- ggplot(datset1, aes(y = task.id, x = learner.id, fill = cv_mean_cindex))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
  ...
  p2 <- ggplot(datset2, aes(y = task.id, x = learner.id, fill = cv_mean_ibrier))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
  ...
  p3 <- ggplot(datset3, aes(y = task.id, x = learner.id, fill = cv_mean_spars))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = label.x, fill = "No. of\nfeatures")+
    theme(legend.position = "right",
...
fig_4 <- function(datset1, datset2, datset3, label, label.x){
  ...
  p1 <- ggplot(datset1, aes(y = task.id, x = approach, fill = cv_mean_cindex))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = "Dataset", fill = "Cindex")+
    theme(legend.position = "right",
  ...
  p2 <- ggplot(datset2, aes(y = task.id, x = approach, fill = cv_mean_ibrier))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = "Dataset",y = "Dataset", fill = "Ibrier")+
    theme(legend.position = "right",
  ...
  p3 <- ggplot(datset3, aes(y = task.id, x = approach, fill = cv_mean_spars))+
    geom_raster()+
    theme_tufte(base_family = "sans")+
    labs(x = label.x, fill = "No. of\nfeatures")+
    theme(legend.position = "right",
...
# 3. x: Dat, y: Learner----
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_learner.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 2.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_allemin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_allemax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_allemed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/dataset_approach_allemean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/learner_dataset.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_cmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_cmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_cmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_imin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_imax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_imed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_smin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_smax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_smed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_allmin.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_allmax.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_allmed.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Comparison/Heatmap/approach_dataset_allmean.pdf", width = pdf_w_h[1], height = pdf_w_h[2] * 1.25)
