...
# 3. x: dataset, y: Mas, color = Approach----
## 3.1 Cindex----
### 3.1.1 Minimum----
h <-
  df %>% 
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmin_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmax_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cmed_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
# 4. x: dataset, y = Mas, color = Approach, Ref = KM
## 3.1 Cindex----
### 3.1.1 Minimum----
h <-
  df %>% 
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmin_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmax_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/km_cmed_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
# 4. x: dataset, y = Mas, color = Approach, Ref = CoxPH
## 3.1 Cindex----
### 3.1.1 Minimum----
h <-
  df %>% 
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_cmin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_cmax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_cmed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_imed.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_cmin_imin.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
...
pdf(file = "C:/Uni/14. Semester/Masterarbeit/Multiple Grafiken/Herrmann/Grafik 2/Multiple Distributions/Linien/cph_cmax_imax.pdf", width = pdf_w_h[1]*2, height = pdf_w_h[2] * 1.5)
